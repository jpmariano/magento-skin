...
(function( $, window, document, undefined ) {
	var ElevateZoom = {
			...
			startZoom: function( ) {
				...
				newNzOffsetTop = self.nzOffset.top;

				self.zoomContainer = $('<div class="zoomContainer" style="-webkit-transform: translateZ(0);position:absolute;left:'+self.nzOffset.left+'px;top:'+newNzOffsetTop+'px;height:'+self.nzHeight+'px;width:'+self.nzWidth+'px;"></div>');
